...
| ID | 태스크 | 유형 | 영역 | 상태 |
|----|--------|------|------|------|
| 2.1.1 | 테스트: 사용자가 이메일과 비밀번호로 회원가입 가능 | BEHAVIORAL | ⚙️ BE | [ ] |
| 2.1.2 | 회원가입 API 라우트 /api/auth/signup 생성 | BEHAVIORAL | ⚙️ BE | [ ] |
| 2.1.3 | 회원가입 페이지 UI /auth/signup 생성 | BEHAVIORAL | 🎨 FE | [ ] |
| 2.1.4 | 테스트: 사용자가 이메일과 비밀번호로 로그인 가능 | BEHAVIORAL | ⚙️ BE | [ ] |
| 2.1.5 | 로그인 API 라우트 /api/auth/login 생성 | BEHAVIORAL | ⚙️ BE | [ ] |
| 2.1.6 | 로그인 페이지 UI /auth/login 생성 | BEHAVIORAL | 🎨 FE | [ ] |
| 2.1.7 | 테스트: 사용자가 로그아웃 가능 | BEHAVIORAL | ⚙️ BE | [ ] |
| 2.1.8 | 로그아웃 기능 생성 | BEHAVIORAL | ⚙️ BE | [ ] |
| 2.1.9 | 테스트: 잘못된 자격 증명 시 에러 메시지 표시 | BEHAVIORAL | 🎨 FE | [ ] |
| 2.1.10 | 로그인 에러 처리 구현 | BEHAVIORAL | 🎨 FE | [ ] |

### 2.2 Google OAuth

| ID | 태스크 | 유형 | 영역 | 상태 |
|----|--------|------|------|------|
| 2.2.1 | 테스트: 사용자가 Google로 로그인 가능 | BEHAVIORAL | ⚙️ BE | [ ] |
| 2.2.2 | Supabase Google OAuth 제공자 설정 | STRUCTURAL | ⚙️ BE | [ ] |
| 2.2.3 | Google OAuth 버튼 컴포넌트 생성 | BEHAVIORAL | 🎨 FE | [ ] |
| 2.2.4 | OAuth 콜백 및 세션 처리 | BEHAVIORAL | ⚙️ BE | [ ] |

### 2.3 비밀번호 재설정

| ID | 태스크 | 유형 | 영역 | 상태 |
|----|--------|------|------|------|
| 2.3.1 | 테스트: 사용자가 비밀번호 재설정 요청 가능 | BEHAVIORAL | ⚙️ BE | [ ] |
| 2.3.2 | 비밀번호 재설정 요청 페이지 /auth/reset 생성 | BEHAVIORAL | 🎨 FE | [ ] |
| 2.3.3 | 비밀번호 재설정 확인 페이지 생성 | BEHAVIORAL | 🎨 FE | [ ] |
| 2.3.4 | 테스트: 사용자가 새 비밀번호 설정 가능 | BEHAVIORAL | ⚙️ BE | [ ] |

### 2.4 사용자 프로필

| ID | 태스크 | 유형 | 영역 | 상태 |
|----|--------|------|------|------|
| 2.4.1 | 테스트: 회원가입 시 사용자 프로필 생성됨 | BEHAVIORAL | ⚙️ BE | [ ] |
| 2.4.2 | 프로필 생성을 위한 users 테이블 트리거 생성 | BEHAVIORAL | ⚙️ BE | [ ] |
| 2.4.3 | 테스트: 사용자가 자신의 프로필 조회 가능 | BEHAVIORAL | ⚙️ BE | [ ] |
| 2.4.4 | 프로필 설정 페이지 /settings/profile 생성 | BEHAVIORAL | 🎨 FE | [ ] |
| 2.4.5 | 테스트: 사용자가 이름 업데이트 가능 | BEHAVIORAL | ⚙️ BE | [ ] |
| 2.4.6 | 프로필 업데이트 기능 구현 | BEHAVIORAL | ⚙️ BE | [ ] |
